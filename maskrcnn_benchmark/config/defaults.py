...
_C.DATASETS.DA_SETTINGS = CN()
_C.DATASETS.DA_SETTINGS.SOURCE_DOMAIN = ()
_C.DATASETS.DA_SETTINGS.TARGET_DOMAIN = ()
...
_C.MODEL.SELF_SUPERVISOR.REGIONS = "targets"  # supports also "detections", "images", "crop"
_C.MODEL.SELF_SUPERVISOR.WEIGHT = 0.05
_C.MODEL.SELF_SUPERVISOR.OUT_CHANNELS = 1024

_C.MODEL.SELF_SUPERVISOR.OSHOT_ITERATIONS = 1
_C.MODEL.SELF_SUPERVISOR.OSHOT_WARMUP = 0
_C.MODEL.SELF_SUPERVISOR.OSHOT_BREAKPOINTS = ()
