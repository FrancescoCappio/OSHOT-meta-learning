...
class CityscapesSimDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, data_dir, split, use_difficult=False, transforms=None):
        ...
        self.foggy = split == 'foggy'

        if split == 'foggy':
            split = 'val'
            self._root_img_path = os.path.join(self.root, 'leftImg8bit_trainval_foggyDBF', 'leftImg8bit_foggyDBF', 'val')
        ...
        self._cls = CityscapesSimDataset.CLASSES
    ...
    def map_class_id_to_class_name(self, class_id):
        return CityscapesSimDataset.CLASSES[class_id]
